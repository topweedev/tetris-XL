...
export const ACTIVE_FILL_ALPHA_BY_PRESET: Record<RenderPreset, number> = { translucent: 0.28, 'high-contrast': 0.15, 'opaque-fallback': 0.28 };
...
export const PIECE_PALETTE: readonly [number, number, number][] = Object.freeze([
  [0.22, 0.90, 0.81], [1, 0.70, 0.33], [0.43, 0.66, 1], [1, 0.44, 0.57], [0.71, 0.55, 1], [0.49, 0.89, 0.55],
